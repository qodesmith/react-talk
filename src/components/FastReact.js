...
const FastReact = props => {
  ...
  return (
    <div {...props} style={{width: size + 'px'}}>
      <svg viewBox='0 0 512.149 512.149' fill={fill} fillOpacity={alpha}>
      ...
      <ReactLogo className='absolute' style={logoStyle} fill={fill} alpha={alpha} />
    </div>
  );
};

export default FastReact;
